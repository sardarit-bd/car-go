  ...
  return (
    <div className="glass-panel p-6 rounded-2xl space-y-4">
      ...
      <form
        ...
        className="grid grid-cols-1 md:grid-cols-12 gap-4 text-xs font-bold text-slate-500 items-end"
      >
        <div className="md:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              value={faqForm.questionPl}
              onChange={(e) =>
                setFaqForm({ ...faqForm, questionPl: e.target.value })
              }
        ...
        <div className="md:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <textarea
              value={faqForm.answerPl}
              onChange={(e) =>
                setFaqForm({ ...faqForm, answerPl: e.target.value })
              }
              rows="2"
        ...
        <div className="md:col-span-2 flex gap-2">
          <button
            type="submit"
            disabled={loading}
            className="flex-1 py-2 bg-brand-red hover:bg-brand-red-hover text-white font-bold rounded transition flex items-center justify-center gap-1"
          >
            {loading ? (
              "Saving..."
            ) : editingFaq ? (
          ...
          {editingFaq && (
            <button
              ...
              className="py-2 px-4 bg-slate-200 text-slate-700 font-bold rounded transition"
            >
              <X className="w-4 h-4" />
            </button>
          )}
          ...
          .map((f) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`px-2 py-0.5 text-[10px] font-bold rounded ${f.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                >
