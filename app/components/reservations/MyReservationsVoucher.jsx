    ...
    <div className="space-y-6 print:space-y-0">
      ...
      <div className="print-voucher-card bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6 relative overflow-hidden print:border-none print:shadow-none print:p-0">
        <div className="border-b-2 border-brand-red pb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 font-semibold mt-1">
              Skarbimierz-Osiedle, Polska | reservations@car-go.pl
            </p>
          </div>
          <div className="sm:text-right">
            ...
            <p className="text-xl font-black text-slate-900 font-mono tracking-widest mt-1">
              {activeBooking.id}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-slate-100 pb-6">
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl">
            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">
              Status rezerwacji / Status
            </p>
            <span
              className={`inline-block mt-2 px-3 py-1.5 rounded-lg text-xs font-black uppercase text-white ${
            ...
            <div className="space-y-3 text-slate-700">
              <div>
                ...
                <p className="text-slate-900 font-semibold mt-1">
                  {activeBooking.dates.pickupDate} o godz.{" "}
              ...
              <div>
                ...
                <p className="text-slate-900 font-semibold mt-1">
                  {activeBooking.dates.returnDate} o godz.{" "}
                  {activeBooking.dates.returnTime}
                </p>
              </div>
              <p className="text-sm text-brand-red font-black pt-2">
                Długość najmu: {activeBooking.pricing.days} dni / days
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm font-semibold border-b border-slate-100 pb-6">
          <div className="space-y-3">
            ...
            <div className="text-slate-700">
              ...
              <p className="text-xs text-slate-500 mt-1">
                Klasa: {activeBooking.car.class} | Skrzynia:{" "}
                {activeBooking.car.transmission === "Automatic"
                  ? t("gearAuto")
                  : activeBooking.car.transmission === "Manual"
                    ? t("gearManual")
                    : activeBooking.car.transmission}
              </p>
              <p className="text-xs text-slate-500 mt-1">
                Paliwo:{" "}
                {activeBooking.car.fuel === "Petrol"
                  ? t("fuelPetrol")
                  : activeBooking.car.fuel === "Diesel"
                    ? t("fuelDiesel")
                    : activeBooking.car.fuel}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="text-slate-700">
              ...
              <p className="text-xs text-slate-500 mt-1">
                Stawka kaucji: PLN {activeBooking.car.deposit}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 text-sm">
          <h3 className="text-xs text-slate-500 uppercase tracking-wider font-black">
            Rozliczenie / Pricing Summary
          </h3>
        ...
        <div className="pt-6 border-t border-slate-100 text-xs text-slate-500 leading-relaxed space-y-2 print:block">
          <p>
            {" "}
            Odbiór pojazdu możliwy wyłącznie po okazaniu dokumentu tożsamości
            oraz ważnego prawa jazdy.
          </p>
          <p>
            {" "}
            Nielimitowany przebieg obowiązuje na terytorium Rzeczypospolitej
            Polskiej.
          </p>
        </div>
      </div>
