...
export default function CheckoutStep3({
  ...
  const handleSelectAll = (e) => {
    ...
    setConsentTerms(isChecked);
    setConsentData(isChecked);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-3">
              <CreditCard
                className={`w-6 h-6 ${paymentMethod === "online" ? "text-brand-red" : "text-slate-400"}`}
              />
              <div>
          ...
          >
            <div className="flex items-center gap-3">
              <User
                className={`w-6 h-6 ${paymentMethod === "pickup" ? "text-brand-red" : "text-slate-400"}`}
              />
              <div>
                <p className="text-sm font-bold text-slate-900">
          ...
          <div className="pl-2 space-y-3 border-l-2 border-slate-200 ml-2.5">
            ...
            <label className="flex items-start gap-3 cursor-pointer py-1">
              <input
                ...
                onChange={(e) =>
                  clearErrorOnCheck(setConsentPrivacy, e.target.checked)
                }
                className="w-5 h-5 accent-brand-red mt-0.5 cursor-pointer rounded"
              />
            ...
            <label className="flex items-start gap-3 cursor-pointer py-1">
              <input
                ...
                onChange={(e) =>
                  clearErrorOnCheck(setConsentTerms, e.target.checked)
                }
                className="w-5 h-5 accent-brand-red mt-0.5 cursor-pointer rounded"
              />
              <span className="text-sm text-slate-700 font-semibold">
            ...
            <label className="flex items-start gap-3 cursor-pointer py-1">
              <input
                ...
                checked={consentData}
                onChange={(e) =>
                  clearErrorOnCheck(setConsentData, e.target.checked)
                }
                className="w-5 h-5 accent-brand-red mt-0.5 cursor-pointer rounded"
              />
              <span className="text-sm text-slate-700 font-semibold">
            ...
            <label className="flex items-start gap-3 cursor-pointer py-2 border-t border-slate-100 pt-4 mt-2">
              <input
                ...
                onChange={(e) =>
                  clearErrorOnCheck(setConsentMarketing, e.target.checked)
                }
                className="w-5 h-5 accent-brand-red mt-0.5 cursor-pointer rounded"
              />
              <span className="text-sm text-slate-700 font-semibold">
