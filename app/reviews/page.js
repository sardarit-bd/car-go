...
export default function Reviews() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-10 animate-fade-in">
      
      {/* Title */}
      <div className="text-center space-y-3">
        <h1 className="text-3xl font-extrabold text-slate-800 uppercase">{t("reviewsTitle")}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col items-center justify-center text-center">
          ...
          <span className="text-sm font-extrabold text-slate-800">100% Zadowolenia</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredReviews.map((rev) => (
            ...
            >
              ...
              <div className="flex justify-between items-center text-[10px] text-slate-400 pt-3 border-t border-slate-100 font-semibold">
      ...
      <div className="p-6 bg-slate-50 border border-slate-200/60 rounded-2xl text-center space-y-3">
        <p className="text-xs text-slate-600">Skorzystałeś z naszych usług? Podziel się swoją opinią logując się na swoje konto klienta.</p>
        <Link
          href="/account/login"
          className="inline-block px-5 py-2 bg-brand-red hover:bg-brand-red-hover text-white text-xs font-bold rounded-lg shadow transition"
        >
