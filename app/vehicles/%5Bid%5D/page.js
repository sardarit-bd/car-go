...
import { ArrowLeft, Users, Briefcase, Settings, Fuel, Compass, AlertTriangle, ShieldCheck } from "lucide-react";
...
export default function VehicleDetails() {
  ...
  if (!car) {
    return (
      <div className="max-w-xl mx-auto text-center py-20 px-4">
        ...
        <Link href="/vehicles" className="inline-flex items-center space-x-1 text-brand-red hover:underline">
  ...
  const handleBookNow = () => {
    // Navigate straight to checkout Step 1 with this car pre-selected
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8 animate-fade-in">
      ...
      {/* Back button */}
      <Link href="/vehicles" className="inline-flex items-center space-x-2 text-xs font-bold text-slate-500 hover:text-slate-800 transition">
        <ArrowLeft className="w-4 h-4" />
        <span>POWRÓT DO KATALOGU / BACK TO VEHICLES</span>
      </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl text-xs text-slate-500 leading-relaxed font-semibold shadow-sm">
            💡 <strong>Rzeczywiste zdjęcia pojazdu:</strong> Prezentowana grafika obrazuje sylwetkę wybranego modelu. Wydawany pojazd może nieznacznie różnić się kolorem lakieru i elementami wyposażenia.
          </div>
        </div>

        {/* Right Side: Specs & Reservation trigger */}
        <div className="lg:col-span-6 space-y-6">
          ...
          {/* Description */}
          <div className="text-sm text-slate-600 font-semibold leading-relaxed border-t border-slate-100 pt-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs font-semibold">
            <div className="p-3 bg-white border border-slate-200 rounded-lg flex items-center space-x-3 shadow-sm">
              ...
              <div>
                <p className="text-slate-400 font-bold">Paliwo / Fuel</p>
            ...
            <div className="p-3 bg-white border border-slate-200 rounded-lg flex items-center space-x-3 shadow-sm">
              ...
              <div>
                <p className="text-slate-400 font-bold">Skrzynia / Gearbox</p>
            ...
            <div className="p-3 bg-white border border-slate-200 rounded-lg flex items-center space-x-3 shadow-sm">
              ...
              <div>
                <p className="text-slate-400 font-bold">Miejsca / Seats</p>
            ...
            <div className="p-3 bg-white border border-slate-200 rounded-lg flex items-center space-x-3 shadow-sm">
              ...
              <div>
                <p className="text-slate-400 font-bold">Bagaż / Luggage</p>
          ...
          {/* Deposit Block */}
          <div className="p-4 bg-slate-100 border border-slate-200 rounded-xl flex items-center justify-between text-xs font-bold">
          ...
          <div className="flex items-center space-x-2 text-xs text-green-600 font-bold pl-1">
            ...
            <span>Nielimitowany przebieg oraz ubezpieczenie OC w cenie!</span>
          </div>

          {/* Book trigger */}
          <button
            onClick={handleBookNow}
            className="w-full py-3.5 bg-brand-red hover:bg-brand-red-hover text-white text-sm font-black rounded-xl shadow hover:shadow-brand-red/20 transition duration-300"
          >
